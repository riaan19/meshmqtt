...
# Clone the repository to /home/pi/meshmqtt
git clone https://github.com/riaan19/meshmqtt.git /home/pi/meshmqtt
...
[Service]
User=pi
WorkingDirectory=/home/pi/meshmqtt
ExecStart=/home/pi/meshmqtt/venv/bin/python /home/pi/meshmqtt/mesh_dashboard.py
Restart=always
...
echo "If you need to configure config.json or other files, edit them in /home/pi/meshmqtt."
